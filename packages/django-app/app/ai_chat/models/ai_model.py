...
class AIModel(UUIDModelMixin, CRUDTimestampsMixin):
    ...
    name = models.CharField(max_length=100, unique=True, help_text="Model name (e.g., gpt-4, claude-3-sonnet)")
    provider = models.ForeignKey(AIProvider, on_delete=models.CASCADE, related_name="models")
    display_name = models.CharField(max_length=200, help_text="Human-readable name for the model")
