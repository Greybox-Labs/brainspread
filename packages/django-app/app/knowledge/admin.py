...
class PageAdmin(admin.ModelAdmin):
    list_display = ('title', 'user', 'slug', 'page_type', 'date', 'created_at', 'modified_at')
...
class BlockAdmin(admin.ModelAdmin):
    list_display = ('content_preview', 'user', 'page', 'parent', 'block_type', 'content_type', 'order', 'created_at')
    ...
    fieldsets = (
        ...
        ('Content', {
            'fields': ('content', 'content_type', 'block_type')
        }),
        ('Properties', {
            'fields': ('properties',),
