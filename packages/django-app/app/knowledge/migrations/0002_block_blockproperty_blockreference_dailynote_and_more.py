...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='block',
            name='page',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='blocks', to='knowledge.page'),
        ),
        migrations.AddField(
            model_name='block',
            name='parent',
        ...
        migrations.AddField(
            ...
            name='block',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='properties', to='knowledge.block'),
        ),
        migrations.AddField(
            model_name='blockreference',
            name='source_block',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='outgoing_references', to='knowledge.block'),
        ),
        migrations.AddField(
            model_name='blockreference',
            name='target_block',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='incoming_references', to='knowledge.block'),
        ),
        migrations.AddField(
            model_name='dailynote',
            name='page',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='daily_note', to='knowledge.page'),
        ),
        migrations.AddField(
            model_name='dailynote',
            name='user',
        ...
        migrations.AddField(
            model_name='pagelink',
            name='source_block',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='outgoing_links', to='knowledge.block'),
        ),
        migrations.AddField(
            model_name='pagelink',
            name='target_page',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='incoming_links', to='knowledge.page'),
        ),
        migrations.AddIndex(
            model_name='block',
