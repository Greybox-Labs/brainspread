...
class TestUpdateBlockCommand(TestCase):
    ...
    def test_should_call_set_tags_from_content_when_content_updated(self, mock_set_tags):
    ...
    @patch.object(Block, "set_tags_from_content")
    def test_should_not_call_set_tags_from_content_when_content_not_updated(self, mock_set_tags):
